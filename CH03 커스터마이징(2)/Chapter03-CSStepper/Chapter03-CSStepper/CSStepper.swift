...
//        self.leftBtn.setTitle("↓", for: .normal) // 버튼의 타이틀
        ...
        self.leftBtn.titleLabel?.font = UIFont.boldSystemFont(ofSize: 20) // 버튼 테두리 타이틀의 폰트
...
//        self.rightBtn.setTitle("↑", for: .normal) // 버튼의 타이틀
        ...
        self.rightBtn.titleLabel?.font = UIFont.boldSystemFont(ofSize: 20) // 버튼 테두리 타이틀의 폰트
...
//        self.centerLabel.backgroundColor = UIColor.cyan // 배경 색상 지정
        ...
        self.centerLabel.layer.borderColor = borderColor //레이블의 테두리 색상 - 하늘색
    ...
    @objc public func valueChange(_ sender: UIButton) {
        ...
        // 스테퍼의 값을 변경하기 전에, 미리 최솟값과 최댓값 법위를 벗어나지 않는지 체크한다.
        ...
        // 더한 결과가 최솟값보다 작으면 값을 변경하지 않고 종료
